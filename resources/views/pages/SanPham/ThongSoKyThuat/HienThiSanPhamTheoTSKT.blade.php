        ...
        <ul class="nav navbar-nav collapse navbar-collapse">
            ...
            <li class="dropdown"><a href="#">Hãng<i class="fa fa-angle-down"></i></a>
                <ul role="menu" class="sub-menu">
                    ...
                    <li class="col-sm-15"><a href="{{ route('/HienThiSanPhamTheoTH', [$valueTHDM->MaThuongHieu, $MaDanhMuc]) }}"><img src="{{ asset('upload/ThuongHieu/'.$valueTHDM->ThuongHieu->HinhAnh) }}" alt=""></a></li>
                    @endforeach
                </ul>
            </li>
            @endif
...
<div class="col-sm-12">
    <div class="features_items">
        <h2 class="title text-center">Sản phẩm có cùng {{ $ThongSoKyThuat->DanhMucTSKT->TenDMTSKT }} : {{ $ThongSoKyThuat->TenTSKT }}</h2>
        @foreach ($sanPhamThuocTSKT as $key => $sanPham)
            @if ($sanPham->SanPham->DanhMuc->MaDanhMuc == $danhMucCha)
                <div class="col-sm-15">
                    <div class="product-image-wrapper">
                        <div class="single-products">
                            <div class="productinfo text-center">
